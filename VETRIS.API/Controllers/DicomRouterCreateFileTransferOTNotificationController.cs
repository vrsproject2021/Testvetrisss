...
{
    public class DicomRouterCreateFileTransferOTNotificationController : ApiController
    {
        public DicomRouterCreateFileTransferOTNotificationResult Post([FromBody]RequestObject.DicomRouterCreateFileTransferOTNotification oReq)
        {
            DicomRouter oDR = new DicomRouter();
            ResponseStatus oRS = new ResponseStatus();
            DicomRouterCreateFileTransferOTNotificationResult oRR = new DicomRouterCreateFileTransferOTNotificationResult();
            bool bReturn = false;
            ...
            try
            {
                ...
                oDR.TRANSFERRED_FILE_COUNT = oReq.transferFileCount;
                oDR.DATE = oReq.uploadDate;
                oDR.TIME_TAKEN = oReq.timeTakenInMinutes;
               
                bReturn = oDR.CreateFileTransferOTNotification();
