<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VRSRadiologistBrw.aspx.cs" Inherits="VETRIS.Masters.VRSRadiologistBrw" %>
...
<head id="Head1" runat="server">
    ...
    <script src="scripts/RadiologistBrwHdr.js?01032020"></script>
</head>
<body>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3 col-xs-12 marginMobileTP10">
                                <div class="form-select-list">
                                    ...
                                    <asp:DropDownList ID="ddlGroup" runat="server" CssClass="form-control custom-select-value"></asp:DropDownList>
                                    ...
                                    <ComponentArt:Grid
                                        ...
                                        <Levels>
                                            <ComponentArt:GridLevel AllowGrouping="true"
                                                ...
                                                <Columns>
                                                    ...
                                                    <ComponentArt:GridColumn DataField="accounts_group" Align="left" HeadingText="Accounts Group" AllowGrouping="false" Width="100" />
                                                    ...
                                                    <ComponentArt:GridColumn DataField="state_name" Align="left" HeadingText="State" AllowGrouping="false" Width="100" />
                                                      <ComponentArt:GridColumn DataField="timezone_name" Align="left" HeadingText="Time Zone" AllowGrouping="false" Width="100" />
                                                    <ComponentArt:GridColumn DataField="is_active" Align="left" HeadingText="Status" AllowGrouping="false" Width="60" />
                                                    <ComponentArt:GridColumn DataField="action" Align="center" HeadingText=" " AllowGrouping="false" Width="100" DataCellClientTemplateId="ACTION" FixedWidth="true" />
                                        ...
                                        <ClientTemplates>
                                            <ComponentArt:ClientTemplate ID="ACTION">
                                                <button type="button" id="btnEdit_## DataItem.GetMember('id').Value ##" class="btn btn-primary btn_grd" title="click to edit radiologist profile"  onclick="javascript:btnEdit_OnClick('## DataItem.GetMember('id').Value ##');">
                                                    <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                                </button>
                                                
                                                <button type="button" id="btnRights_## DataItem.GetMember('id').Value ##" class="btn btn-warning btn_grd" title="click to configure functional and other rights" onclick="javascript:btnRights_OnClick('## DataItem.GetMember('id').Value ##','## DataItem.GetMember('name').Value ##');">
    ...
    <script type="text/javascript">
        ...
        var objddlGroup = document.getElementById('<%=ddlGroup.ClientID %>');
        ...
        var strForm = "VRSRadiologistBrw";

</script>
<script src="../scripts/custome-javascript.js"></script>
<script src="../scripts/AppPages.js"></script>
<script src="scripts/RadiologistBrw.js?07042020"></script>
</html>
