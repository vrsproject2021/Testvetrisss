...
function SearchRecord() {
    ...
    ArrRecords[3] = "N"; if (objchkRecDt.checked) ArrRecords[3] = "Y";
...
function btnAL_OnClick(ID, SUID) {
    ...
    parent.GiTop = 30;
    parent.GiBuffHt = 250;
    parent.GsLaunchURL = "HouseKeeping/VRSStatusAuditTrail.aspx?id=" + ID + "&suid=" + SUID + "&th=" + selTheme;
...
function btnRpt_OnClick(ID, URL, PatientName, CustomRpt,Format) {
    ...
    if (CustomRpt == "N")
        parent.GsLaunchURL = "CaseList/DocPrint/VRSDocPrint.aspx?DocID=1&ID=" + ID + "&PNM=" + PatientName + "&UID=" + UserID + "&FMT=" + Format;
    else
        parent.GsLaunchURL = "CaseList/DocPrint/VRSDocPrint.aspx?DocID=3&ID=" + ID + "&PNM=" + PatientName + "&UID=" + UserID + "&FMT=" + Format;
