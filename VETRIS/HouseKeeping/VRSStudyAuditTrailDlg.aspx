...
<head runat="server">
    ...
    <script src="scripts/StudyAuditTrailDlgHdr.js?11022020"></script>
</head>
<body>
                                ...
                                <div class="col-sm-12 col-xs-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9 col-xs-12 marginTP10">
                                            <div id="divReason" style="width: 98%; height: 80px; overflow: auto" runat="server" CssClass="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9 col-xs-12 marginTP10">
                                            <div id="divPhysNote" style="width: 98%; height: 80px; overflow: auto" runat="server">
                                            </div>
                                        </div>
                                    </div>
...
<script src="scripts/StudyAuditTrailDlg.js"></script>
</html>
