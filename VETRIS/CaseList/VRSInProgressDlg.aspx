<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VRSInProgressDlg.aspx.cs" Inherits="VETRIS.CaseList.VRSInProgressDlg" %>
...
<head runat="server">
    ...
    <script src="scripts/InProgressDlgHdr.js?v=<%=DateTime.Now.Ticks%>"></script>
</head>
<body>
    <form id="form1" runat="server">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="sparklineHeader mt-b-10 marginTP10">
                <div class="sparkline10-hd">
                    <div class="row">
                        ...
                        <%--<div class="col-sm-2 col-xs-12">
                            <button type="button" class="btn btn-custon-four btn-danger" id="btnDel1" runat="server" style="display: none;">
                ...
                <div class="sparkline10-hd">
                    <div class="row">
                        ...
                        <div class="col-sm-4 col-xs-4">
                            ...
                            <asp:Label ID="lblAssnRad" runat="server"></asp:Label>
                        </div>
                        ...
                        <div class="col-sm-12 col-xs-12">
                            <div class="searchSection marginTP10">
                                <div class="row">
                                    <div class="col-sm-12 col-xs-12">
                                        <div class="pull-left">
                                            <h3 class="h3Text">Comparative studies of the patient</h3>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-xs-12 marginMobileTP5">
                                        <div class="table-responsive">
                                            <ComponentArt:CallBack ID="CallBackPS" runat="server" OnCallback="CallBackPS_Callback">
                                                <Content>
                                                    <ComponentArt:Grid
                                                        ID="grdPS"
                                                        CssClass="Grid"
                                                        ...
                                                        <Levels>
                                                            <ComponentArt:GridLevel
                                                                ...
                                                                SortImageHeight="19">
                                                                <ConditionalFormats>
                                                                    <ComponentArt:GridConditionalFormat ClientFilter="((DataItem.get_index() + grdPS.get_recordOffset()) % 2) > 0" RowCssClass="AltRow" SelectedRowCssClass="AltRow" />
                                                                    <ComponentArt:GridConditionalFormat ClientFilter="((DataItem.get_index() + grdPS.get_recordOffset()) % 2) == 0" RowCssClass="Row" SelectedRowCssClass="Row" />
                                                                </ConditionalFormats>
                                                                <Columns>
                                                                    ...
                                                                    <ComponentArt:GridColumn DataField="status_desc" Align="left" HeadingText="Status" AllowGrouping="false" Width="100" />
                                                                    ...
                                                                    <ComponentArt:GridColumn DataField="radiologist" Align="left" HeadingText="Radiologist" AllowGrouping="false" DataCellClientTemplateId="RADIOLOGIST" FixedWidth="True" Width="130" Visible="false" />
                                                                    ...
                                                                    <ComponentArt:GridColumn DataField="patient_name" Align="left" HeadingText="patient_name" AllowGrouping="false" Visible="false" />
                                                                    <ComponentArt:GridColumn Align="center" HeadingText="Select" AllowGrouping="false" DataCellClientTemplateId="SELPS" FixedWidth="True" Width="40" />
                                                                    <ComponentArt:GridColumn Align="center" HeadingText=" " AllowGrouping="false" DataCellClientTemplateId="ACTION" FixedWidth="True" Width="40" />
                                                        ...
                                                        <ClientEvents>
                                                            <RenderComplete EventHandler="grdPS_onRenderComplete" />
                                                        </ClientEvents>
                                                        ...
                                                        <ClientTemplates>
                                                            ...
                                                            <ComponentArt:ClientTemplate ID="RADIOLOGIST">
                                                                <span id="spnRad_## DataItem.GetMember('id').Value ##" title="## DataItem.GetMember('radiologist').Value ##">## DataItem.GetMember('radiologist_pacs').Value ##</span>
                                                            </ComponentArt:ClientTemplate>

                                                            <ComponentArt:ClientTemplate ID="ACTION">

                                                                <button type="button" id="btnRpt_## DataItem.GetMember('id').Value ##" class="btn btn-success btn_grd" title="Report" style="display: none;" onclick="javascript:btnRpt_OnClick('## DataItem.GetMember('id').Value ##','## DataItem.GetMember('patient_name').Value ##','## DataItem.GetMember('study_status_pacs').Value ##');">
                                                                    <i class="fa fa-file-text-o" aria-hidden="true"></i>
                                                                </button>
                                                                <%--<button type="button" id="btnImg_## DataItem.GetMember('id').Value ##" class="btn btn-warning btn_grd" title="Image(s)" onclick="javascript:btnImg_OnClick('## DataItem.GetMember('study_uid').Value ##');">
                                                                    <i class="fa fa-file-image-o" aria-hidden="true"></i>
                                                                </button>--%>
                                                            </ComponentArt:ClientTemplate>
                                                            <ComponentArt:ClientTemplate ID="SELPS">
                                                                <div class="grid_option">
                                                                    <input type="checkbox" id="chkSelPS_## DataItem.GetMember('id').Value ##" style="width: 18px; height: 18px; margin-top: 8px;" onclick="javascript: chkSelPS_OnClick('## DataItem.GetMember('id').Value ##');" />
                                                                    <label for="chkSelPS_## DataItem.GetMember('id').Value ##" class="label-default" style="width: auto; margin-top: 10px;"></label>
                                                                </div>
                                                            </ComponentArt:ClientTemplate>
                                                    ...
                                                    <span id="spnErrStudy" runat="server"></span>
                                                </Content>
                                                ...
                                                <ClientEvents>
                                                    <CallbackComplete EventHandler="grdPS_onCallbackComplete" />
                                                </ClientEvents>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-xs-12">
                                        <div class="borderSearch pull-left"></div>
                                        <div class="col-sm-4 col-xs-12  pull-right text-right" style="margin-top: 3px;">
                                             <button type="button" class="btn btn-custon-four btn-primary" id="btnDLImg" runat="server">
                                                <i class="fa fa-download" aria-hidden="true"></i>&nbsp;Download Images   
                                            </button>
                                            <button type="button" class="btn btn-custon-four btn-warning" id="btnImg" runat="server">
                                                <i class="fa fa-file-image-o" aria-hidden="true"></i>&nbsp;View/Compare Images   
                                            </button>
                                        ...
                                        <div class="col-sm-3 col-xs-12  pull-right">
                                            <div class="optSwitch pull-left" style="margin-left: 10%; margin-bottom: 20px;">
                                                <asp:CheckBox ID="chkIncStudy" runat="server" Checked="true" />
                                                <label for="chkIncStudy" class="label-default"></label>
                                            </div>
                                            <div class="pull-left" style="margin-top: 10px; margin-left: 20px;">Include the currently opened study</div>
            ...
            <div class="sparkline10-list mt-b-10">
                    ...
                    <div class="col-sm-6 col-xs-12">
                        <div class="searchSection marginTP10">
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <div class="pull-left">
                                        <h3 class="h3Text">Private Note For Radiologist</h3>
                                    </div>
                                    <div class="borderSearch pull-left"></div>
                                </div>
                            </div>
                    ...
                    <div class="col-sm-6 col-xs-12">
                        <div class="searchSection marginTP10">
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <div class="row">
                                        <div class="col-sm-8 col-xs-8 marginTP5">
                ...
                <div class="row">
                    <div class="col-sm-12 col-xs-12">
                        ...
                        <div class="searchSection marginTP10">
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <div class="col-sm-6 col-xs-12 pull-left" style="margin-top: 5px;">
                                        <h3 class="h3Text">Observations</h3>
                                    </div>
                                    <div class="col-sm-6 col-xs-12 text-right">
                                        <button type="button" class="btn btn-custon-four btn-warning" id="btnTranslate" runat="server">
                                            <i class="fa fa-globe edu-danger-error" aria-hidden="true"></i>&nbsp;Translate To English   
                                        </button>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-xs-12" id="rptEditor" style="display: none;">
                                    ...
                                    <CKEditor:CKEditorControl ID="editorFindings" runat="server"
                                        DisableNativeSpellChecker="false" RemovePlugins="scayt,contextmenu"
                            ...
                            <%--<div class="row" ID="TranslatedDiv" runat="server" style="display:none;">

                                <div class="col-sm-12 col-xs-12">

                                    <CKEditor:CKEditorControl ID="editorFindingsTranslated" runat="server"
                                        Toolbar="Source|-|NewPage|Preview|-|Templates
                ...
                <div class="row" id="divTranslate" style="display: none;">
                    <div class="col-sm-12 col-xs-12">
                        ...
                        <div class="searchSection marginTP10">
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <div class="col-sm-6 col-xs-12 pull-left" style="margin-top: 5px;">
                                        <h3 style="color: #1e77bb;">Observations (Translated)</h3>
                                    </div>
                                    <div class="col-sm-6 col-xs-12 text-right">
                                        <a class="collapse-link" id="aRTransCollapse">
                            ...
                            <div class="row" id="divTransRpt">

                                <div class="col-sm-12 col-xs-12">

                                    <CKEditor:CKEditorControl ID="editorFindingsTranslated" runat="server" DisableNativeSpellChecker="false" RemovePlugins="scayt,contextmenu"
                                        Toolbar="Source|-|NewPage|Preview|-|Templates
                                                                                Cut|Copy|Paste|PasteText|PasteFromWord|-|Print
                                                                                Undo|Redo|-|Find|Replace|-|Bold|Italic|Underline|-|Subscript|Superscript
                                                                                NumberedList|BulletedList|-|Outdent|Indent
                    ...
                    <div class="col-sm-12 col-xs-12">
                        <div class="searchSection marginTP10">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-xs-12">
                                    <div class="col-sm-12 col-xs-12" id="divStat">
                                        <div class="row">
                                            <div class="col-sm-4 col-xs-12 marginTP5">
                                                Change Status To <span class="mandatory">*</span>
                                            </div>
                                            <div class="col-sm-8 col-xs-12 marginMobileTP5">
                                                <div class="pull-left grid_option customRadio" id="divStatDict">
                                                ...
                                                <span class="pull-left" style="padding-left: 0; padding-top: 5px; padding-right: 2px;" id="spnStatDict">Dictated</span> &nbsp;&nbsp;
                                                <div class="pull-left grid_option customRadio marginLFT10" id="divStatPrelim">
                                                ...
                                                <span class="pull-left" style="padding-left: 0; padding-top: 5px; padding-right: 2px;" id="spnStatPrelim">Preliminary</span>&nbsp;&nbsp;
                                                <div class="pull-left grid_option customRadio marginLFT10" id="divStatFinal">
                                                ...
                                                <span class="pull-left" style="padding-left: 0; padding-top: 5px; padding-right: 2px;" id="spnStatFinal">Final</span>
                                ...
                                <div class="col-sm-2 col-xs-12" id="divTeach" style="display:block;">
                                    <div class="optSwitch pull-left" style="margin-bottom: 0px; margin-top: -4px;">
                                        <asp:CheckBox ID="chkTeach" runat="server" />
                                        <label for="chkTeach" class="label-default"></label>
                                    </div>
                                    <div class="pull-left" style="margin-top: 5px; margin-left: 20px;">Mark for teaching</div>
                ...
                <div class="row" id="divRateRpt" style="display: none;">
                    <div class="col-sm-12 col-xs-12">
                        <div class="searchSection marginTP10">
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    ...
                                    <div class="pull-left">
                                        <h3 class="h3Text">Rate The Report By 
                                            &nbsp;<asp:Label ID="lblPrevRad" runat="server"></asp:Label>
                                            <span class="mandatory">*</span></h3>
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-xs-12">
                                    <div class="pull-left grid_option customRadio">
                                        <asp:RadioButton ID="rdoNormal" runat="server" GroupName="grpRpt" />
                                        <label for="rdoNormal" class="label-default" style="width: auto; margin-top: 10px;"></label>
                                    </div>
                                    <span class="pull-left" style="padding-left: 0; padding-top: 5px; padding-right: 2px;">Normal</span>
                                    <div class="pull-left grid_option customRadio marginLFT10">
                                        <asp:RadioButton ID="rdoAbnormal" runat="server" GroupName="grpRpt" />
                                        <label for="rdoAbnormal" class="label-default" style="width: auto; margin-top: 10px;"></label>
                                    </div>
                                    <span class="pull-left" style="padding-left: 0; padding-top: 5px; padding-right: 2px;">Abnormal</span>&nbsp;&nbsp;
                                </div>
            ...
            <div class="sparklineHeader marginTP10">
                <div class="sparkline10-hd">
                    <div class="row">
                        ...
                        <%-- <div class="col-sm-2 col-xs-12">
                            <button type="button" class="btn btn-custon-four btn-danger" id="btnDel2" runat="server" style="display: none;">
                                <i class="fa fa-trash-o edu-danger-error" aria-hidden="true"></i>&nbsp;DELETE CASE   
                            </button>
                        </div>--%>
                        <div class="col-sm-4 col-xs-12 text-center">
        ...
        <input type="hidden" id="hdnGOOGLETRANSAPILINK" runat="server" value="" />
        <input type="hidden" id="hdnGOOGLETRANSAPIKEY" runat="server" value="" />
        <input type="hidden" id="hdnRecByRouter" runat="server" value="N" />
        <input type="hidden" id="hdnLang" runat="server" value="" />
        <input type="hidden" id="hdnShowTranslation" runat="server" value="N" />
...
<script type="text/javascript">
    ...
    var objhdnGOOGLETRANSAPILINK = document.getElementById('<%=hdnGOOGLETRANSAPILINK.ClientID %>');
    var objhdnGOOGLETRANSAPIKEY = document.getElementById('<%=hdnGOOGLETRANSAPIKEY.ClientID %>');
    var objhdnRecByRouter = document.getElementById('<%=hdnRecByRouter.ClientID %>');
    var objhdnLang = document.getElementById('<%=hdnLang.ClientID %>');
    var objhdnShowTranslation = document.getElementById('<%=hdnShowTranslation.ClientID %>');
    ...
    var objchkIncStudy = document.getElementById('<%=chkIncStudy.ClientID %>');
    var objbtnTranslate = document.getElementById('<%=btnTranslate.ClientID %>');
    var objrdoDict = document.getElementById('<%=rdoDict.ClientID %>');
    var objrdoPrelim = document.getElementById('<%=rdoPrelim.ClientID %>');
    var objrdoFinal = document.getElementById('<%=rdoFinal.ClientID %>');
    var objrdoNormal = document.getElementById('<%=rdoNormal.ClientID %>');
    var objrdoAbnormal = document.getElementById('<%=rdoAbnormal.ClientID %>');
    ...
    var objbtnSaveTrans1 = document.getElementById('<%=btnSaveTrans1.ClientID %>');
    var objbtnSaveTrans2 = document.getElementById('<%=btnSaveTrans2.ClientID %>');
    var objeditorFindings = document.getElementById('<%=editorFindings.ClientID %>');
    ...
    var strForm = "VRSInProgressDlg";

</script>
<script src="../scripts/custome-javascript.js"></script>
<script src="../scripts/AppPages.js?v=<%=DateTime.Now.Ticks%>"></script>
<script src="scripts/InProgressDlg.js?v=<%=DateTime.Now.Ticks%>"></script>
</html>
