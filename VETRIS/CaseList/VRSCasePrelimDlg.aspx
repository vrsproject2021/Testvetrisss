...
<head runat="server">
    ...
    <script src="scripts/CasePrelimDlgHdr.js?v=<%=DateTime.Now.Ticks%>" type="text/javascript"></script>
</head>
<body>
    <form id="form1" runat="server">
                    ...
                    <div class="col-sm-6 col-xs-12">
                        <div class="searchSection marginTP10">
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <div class="pull-left">
                                        <h3 class="h3Text">Private Note For Physician</h3>
                                    </div>
                                    <div class="borderSearch pull-left"></div>
                                </div>
                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 col-xs-12 marginMobileTP5">
                                                <div class="pull-left grid_option customRadio">
                                                    <asp:RadioButton ID="rdoFinalY" runat="server" GroupName="grpStat" />
                                                    <label for="rdoFinalY" class="label-default" style="width: auto; margin-top: 10px;"></label>
                                                </div>
                                                ...
                                                <div class="pull-left grid_option customRadio marginLFT10">
                                                    <asp:RadioButton ID="rdoFinalN" runat="server" GroupName="grpStat" />
                                                    <label for="rdoFinalN" class="label-default" style="width: auto; margin-top: 10px;"></label>
                                                </div>
                        ...
                        <div class="searchSection marginTP10">
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    ...
                                    <div class="pull-left">
                                        <h3 class="h3Text">Rate The Preliminary Report By 
        ...
        <input type="hidden" id="hdnPrevRadID" runat="server" value="00000000-0000-0000-0000-000000000000" />
...
<script type="text/javascript">
    ...
    var objhdnPrevRadID = document.getElementById('<%=hdnPrevRadID.ClientID %>');
    ...
    var objrdoFinalY = document.getElementById('<%=rdoFinalY.ClientID %>');
    var objrdoFinalN = document.getElementById('<%=rdoFinalN.ClientID %>');
...
<script src="scripts/CasePrelimDlg.js?v=<%=DateTime.Now.Ticks%>"></script>
</html>
