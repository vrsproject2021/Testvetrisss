<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VRSCaseFinalDlg.aspx.cs" Inherits="VETRIS.CaseList.VRSCaseFinalDlg" %>
...
<head runat="server">
    ...
    <script src="scripts/CaseFinalDlgHdr.js?v=<%=DateTime.Now.Ticks%>" type="text/javascript"></script>
</head>
<body>
    <form id="form1" runat="server">
        ...
        <input type="hidden" id="hdnAbRptReasonID" runat="server" value="00000000-0000-0000-0000-000000000000" />
...
<script type="text/javascript">
    ...
    var objhdnAbRptReasonID = document.getElementById('<%=hdnAbRptReasonID.ClientID %>');
    ...
    var strForm = "VRSCaseFinalDlg";

</script>
<script src="../scripts/custome-javascript.js"></script>
<script src="../scripts/AppPages.js?v=<%=DateTime.Now.Ticks%>"></script>
<script src="scripts/CaseFinalDlg.js?v=<%=DateTime.Now.Ticks%>"></script>
</html>
