namespace VETRISSchedulerInstaller.UserControls
{
    partial class ucUpdateWiz1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label5.Text = "Click on \"Next\" button to update the existing VETRIS Scheduler Services installat" +
    "ion";
            // 
            // lblInstallPath
            // 
