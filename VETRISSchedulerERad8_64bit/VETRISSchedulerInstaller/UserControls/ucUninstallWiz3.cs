...
namespace VETRISSchedulerInstaller.UserControls
{
    public partial class ucUninstallWiz3 : UserControl
    {
        ...
        private void ucUninstallWiz3_Load(object sender, EventArgs e)
        {
            ...
            {
                lblInstallResult.Text = "VETRIS Scheduler Services is uninstalled successfully.";
            }
            else
            {
                lblInstallResult.Text = "VETRIS Scheduler Services is uninstalled with some errors.";
                lblErr.Visible = true;
