...
namespace VETRISScheduler.Core
{
    public class MailSender
    {
        ...
        #region SendMail
        public bool SendMail(ref string ReturnMesssage)
        {
            ...
            try
            {
                objMailAddressFrom = new MailAddress(MailFrom);
                ...
                //string  appcode = CoreCommon.DecryptString(mEmailPwd);
                NetworkCredential oBasicAuth = new NetworkCredential(mEmailUserId, mEmailPwd); // cdknazrppumhgmtq
