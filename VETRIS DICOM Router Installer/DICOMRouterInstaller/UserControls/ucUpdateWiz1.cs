...
namespace DICOMRouterInstaller.UserControls
{
    public partial class ucUpdateWiz1 : UserControl
    {
        ...
        private void CreateLicenseFile()
        {
            ...
            if (!File.Exists(strInstallPath + "\\DRLicense.lic"))
            {
                strEncInstCode = IL.Common.EncryptString(strInstCode);
                TextWriter tw = new StreamWriter(strInstallPath + "\\DRLicense.lic");
